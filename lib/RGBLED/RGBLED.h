...
public:
  ...
  uint8_t MODE_BOOT_SETUP = 9;
  uint8_t MODE_WIFI_CONNECTING = 10;
  uint8_t SERVER_CONNECTED = 11;
  uint8_t APP_CONNECTED = 12;
...
private:
  ...
  unsigned long MODE_WIFI_CONNECTING_SEQUENCE[2] = {cycleDelay, pulseDuration}; //One Flash
  int MODE_WIFI_CONNECTING_COLOR[3] = {255,255,255};
  int MODE_WIFI_CONNECTING_INDEX_STATE[2] = {0, 1};
  int MODE_WIFI_CONNECTING_SIZE = 2;

  unsigned long MODE_SERVER_CONNECTED_SEQUENCE[2] = {cycleDelay, pulseDuration}; //One Flash
  int MODE_SERVER_CONNECTED_COLOR[3] = {0,255,0};
  int MODE_SERVER_CONNECTED_INDEX_STATE[2] = {0, 1};
  int MODE_SERVER_CONNECTED_SIZE = 2;

  unsigned long MODE_APP_CONNECTED_SEQUENCE[1] = {pulseDuration}; //One Flash
  int MODE_APP_CONNECTED_COLOR[3] = {0,255,0};
  int MODE_APP_CONNECTED_INDEX_STATE[2] = {1};
  int MODE_APP_CONNECTED_SIZE = 1;
};
